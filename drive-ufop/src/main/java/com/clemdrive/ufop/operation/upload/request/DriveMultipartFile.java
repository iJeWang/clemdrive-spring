package com.clemdrive.ufop.operation.upload.request;
...
public class DriveMultipartFile {

    MultipartFile multipartFile = null;

    private DriveMultipartFile() {
    }

    public DriveMultipartFile(MultipartFile multipartFile) {
