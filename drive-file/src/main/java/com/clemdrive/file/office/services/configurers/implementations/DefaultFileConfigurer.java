...
import com.clemdrive.file.office.documentserver.managers.jwt.JwtManager;
import com.clemdrive.file.office.documentserver.models.enums.Action;
import com.clemdrive.file.office.documentserver.models.enums.DocumentType;
import com.clemdrive.file.office.documentserver.models.filemodel.FileModel;
...
import com.clemdrive.file.office.services.configurers.FileConfigurer;
import com.clemdrive.file.office.services.configurers.wrappers.DefaultDocumentWrapper;
...
public class DefaultFileConfigurer implements FileConfigurer<DefaultFileWrapper> {
    ...
    @Autowired
    private Mapper<com.clemdrive.file.office.entities.Permission, Permission> mapper;
